...
<head>
        ...
        <title>About us | Home Decor Store</title>
...
<div class="container" id="content">
    ...
    <div class="row">
        <div class="col-lg-4" align="justify">
            ...
            <p id="p1">Home Decor Store stands out as a prominent figure in the ecommerce sector, demonstrating unwavering dedication to prosperity and maintaining a track record of excellence in service delivery.<br><br>The company was founded in 2024 by Cyrus Kipruto to ease the process of ordering various items. From those early days with just one employee, Home Decor Store has expanded its team significantly, now serving thousands of customers. <br><br>Home Decor Store is guided by four principles: customer obsession rather than competitor focus, passion for invention, commitment to operational excellence, and long-term thinking.<br><br><h4><mark>Vision</mark></h4>To make the world a more stylish, colorful and happier place.<br><br><h4><mark>Mission</mark></h4>We strive to offer our customers the lowest possible prices, the best available selection, and the utmost convenience.</p>            </p>
        </div>
        <div class="col-lg-4" align="justify">
